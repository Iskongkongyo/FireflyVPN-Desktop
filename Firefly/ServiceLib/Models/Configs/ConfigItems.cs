...
public class GUIItem
{
    ...
    public bool StatisticsPreferenceInitialized { get; set; }
...
public class UIItem
{
    ...
    public bool FireflyProtectedColumnLayoutMigrated { get; set; }
    public bool NewUserGuideCompleted { get; set; }
    public int StartupSplashDurationSeconds { get; set; } = 10;
...
public class ConstItem
{
    ...
    public string? FireflyApiUrl { get; set; } = Global.FireflyClientApiUrl;
    public string? FireflyLastNoticeId { get; set; }
    public bool FireflySubscriptionCatalogInitialized { get; set; }
    public List<string>? FireflyKnownSubscriptionIds { get; set; } = [];
    public List<string>? FireflyUnreadSubscriptionIds { get; set; } = [];
}
