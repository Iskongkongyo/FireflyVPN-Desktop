...
public class Global
{
    public const string AppName = FireflyBranding.ProductName;
    public const int FireflyVersionCode = 2;
    public static string FireflyClientApiUrl => FireflyBranding.ClientApiUrl;
    ...
    public const string AvaAssets = "avares://Firefly/Assets/";
