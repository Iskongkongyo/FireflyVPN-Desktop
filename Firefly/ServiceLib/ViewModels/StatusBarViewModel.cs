...
public partial class StatusBarViewModel : MyReactiveObject
{
    ...
    public async Task RefreshServersBiz()
    {
        ...
        if (running != null)
        {
            RunningServerDisplay = await FireflyManagedSubscriptionPolicy.GetSafeSummaryAsync(running);
    ...
    private async Task RefreshServersMenu()
    {
        ...
        {
            FireflyManagedSubscriptionPolicy.MaskProfileForDisplay(it, managedSubscriptionIds);
