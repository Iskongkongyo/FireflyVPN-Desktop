...
public partial class OptionSettingViewModel : MyReactiveObject, ICloseable
{
    ...
    [Reactive] public partial bool EnableConnectionRecovery { get; set; }
    ...
    private async Task Init()
    {
        ...
        EnableConnectionRecovery = _config.GuiItem.EnableConnectionRecovery;
    ...
    private async Task InitCoreType()
    {
        ...
        foreach (var it in Enum.GetValues<EConfigType>())
        {
            ...
            {
                ConfigType = it,
                CoreType = FireflyBranding.GetDefaultCoreType(it)
            });
        }
    ...
    private async Task SaveSettingAsync()
    {
        ...
        _config.GuiItem.EnableConnectionRecovery = EnableConnectionRecovery;
